...
export class RequestService {
  ...
  approve(request: Request): Observable<JsonResponse> {
    return this.http.put(this.url + "approve", request) as Observable<
      JsonResponse
    >;
  }

  reject(request: Request): Observable<JsonResponse> {
    return this.http.put(this.url + "reject", request) as Observable<
      JsonResponse
    >;
  }
  ...
  submitForReview(request: Request): Observable<JsonResponse> {
    return this.http.put(this.url + "submit-review", request) as Observable<
      JsonResponse
    >;
  }

  linesForReview(id: number): Observable<JsonResponse> {
    return this.http.get(this.url + "list-review/" + id) as Observable<
      JsonResponse
    >;
  }
}
